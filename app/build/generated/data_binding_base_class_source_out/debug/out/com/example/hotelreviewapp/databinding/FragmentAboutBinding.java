...
public final class FragmentAboutBinding implements ViewBinding {
  ...
  private FragmentAboutBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView imageView,
      @NonNull TextView info1, @NonNull TextView textView) {
  ...
  public static FragmentAboutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentAboutBinding((ConstraintLayout) rootView, imageView, info1, textView);
    }
